...
const COMPANIES = [
  ...
  },
  {
    ...
    story: "חברה ותיקה ומבוססת עם צמיחה סולידית ועקבית לאורך שנים. מייצרת הכנסות ורווחים יציבים ומחלקת דיבידנד באופן קבוע.",
    startPrice: 30000,
  },
  {
...
const YEARS = [
  // Trial
  {
    ...
    prime: { rev: "₪900M", profit: "₪120M",  profitClass: "pos", news: "החברה ממשיכה להציג יציבות ורווחיות גבוהה.", price: 30000 },
  ...
  // Year 1
  {
    ...
    prime: { rev: "₪950M",  profit: "₪130M", profitClass: "pos", news: "החברה מעלה תחזית שנתית ומחלקת דיבידנד.", price: 33000 },
  ...
  // Year 2
  {
    ...
    prime: { rev: "₪1.0B",  profit: "₪142M", profitClass: "pos", news: "ביצועים עקביים, אך חלק מהאנליסטים טוענים שהמניה יקרה.", price: 36000 },
  ...
  // Year 3
  {
    ...
    prime: { rev: "₪1.06B", profit: "₪155M", profitClass: "pos", news: "החברה ממשיכה לצמוח לאט אך בעקביות.", price: 39600 },
  ...
  // Year 4
  {
    ...
    prime: { rev: "₪1.12B", profit: "₪168M", profitClass: "pos", news: "ההנהלה שומרת על מדיניות שמרנית ועל רווחיות יציבה.", price: 43500 },
  ...
  // Year 5
  {
    ...
    prime: { rev: "₪1.2B",  profit: "₪182M", profitClass: "pos", news: "עוד שנה יציבה לחברה הוותיקה.", price: 48000 },
