...
const YEARS = [
  // Trial
  {
    ...
    prime: { rev: "₪1.1B", profit: "₪180M",  profitClass: "pos", news: "החברה ממשיכה להציג יציבות ורווחיות גבוהה.", price: 5000 },
  ...
  // Year 1
  {
    ...
    prime: { rev: "₪950M",  profit: "₪130M", profitClass: "pos", news: "החברה מעלה תחזית שנתית ומחלקת דיבידנד.", price: 5500 },
  ...
  // Year 2
  {
    ...
    prime: { rev: "₪1.0B",  profit: "₪142M", profitClass: "pos", news: "ביצועים עקביים, אך חלק מהאנליסטים טוענים שהמניה יקרה.", price: 6000 },
  ...
  // Year 3
  {
    ...
    prime: { rev: "₪1.06B", profit: "₪155M", profitClass: "pos", news: "החברה ממשיכה לצמוח לאט אך בעקביות.", price: 6600 },
  ...
  // Year 4
  {
    ...
    prime: { rev: "₪1.12B", profit: "₪168M", profitClass: "pos", news: "ההנהלה שומרת על מדיניות שמרנית ועל רווחיות יציבה.", price: 7250 },
  ...
  // Year 5
  {
    ...
    prime: { rev: "₪1.2B",  profit: "₪182M", profitClass: "pos", news: "עוד שנה יציבה לחברה הוותיקה.", price: 8000 },
